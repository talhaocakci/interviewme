...
This will:
- Deploy AWS infrastructure (S3, CloudFront, Lambda, DynamoDB, **AWS Secrets Manager**)
- Store secrets in AWS Secrets Manager (not GitHub!)
- Set up GitHub Actions for automatic deployment
- Initialize Git repository and push to GitHub

**Zero GitHub secrets needed** when using GitHub OIDC (recommended!)  
Or **only 2 secrets** if using access keys (AWS credentials)  
**Everything else** (API URLs, S3 bucket, CloudFront ID, etc.) is stored in **AWS Secrets Manager** for better security.

See:
- [OIDC_QUICK_START.md](./OIDC_QUICK_START.md) - **Recommended**: Use OIDC (no access keys!)
- [GITHUB_OIDC_SETUP.md](./GITHUB_OIDC_SETUP.md) - Full OIDC guide
- [GITHUB_DEPLOY.md](./GITHUB_DEPLOY.md) - GitHub Actions setup guide
- [AWS_SECRETS_MANAGER.md](./AWS_SECRETS_MANAGER.md) - Secrets management details
- [SECRETS_QUICK_REFERENCE.md](./SECRETS_QUICK_REFERENCE.md) - Quick commands
...
✅ **Secrets Management**: AWS Secrets Manager for centralized secret storage with automatic rotation support
...
- [x] CI/CD pipeline (GitHub Actions with AWS Secrets Manager)
